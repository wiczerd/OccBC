...
// 0.497849,2.498595,0.030000,0.031210,0.022886,1.149445,
//0.492140,2.554236,0.040000,0.031563,0.075575,1.092015,

double ** chi;


double 	phi		= 0.492140;	// : log(1/UE elasticity -1) = phi*log(theta)= log(1/.38-1)/log(5)
double 	sig_psi	= 2.554236; 	// higher reduces the switching prob
double 	tau 	= 0.040000;
double 	scale_s	= 0.031563;
double 	shape_s	= 0.075575;
double 	effic	= 1.092015;
...
int main(int argc,char *argv[]){
	...
	*/
	...
	double lb_0[]	= {0.35	,0.001		,0.001	,0.015		,0.0001		,0.5	,-5.0			,-5.0			,-5.0	}; // what to do about sig_psi?  Skipping that right now
	double ub_0[]	= {0.75	,3.5		,0.04	,0.05		,0.20		,1.5	,.01				,.01		,.01	};
