...
double 	phi		= 0.402140;	// : log(1/UE elasticity -1) = phi*log(theta)= log(1/.38-1)/log(5)
double 	fm_shr	= 0.66;	// firm's surplus share
double 	effic	= 1.499987;
...
int main(int argc,char *argv[]){
	...
	*/
	...
	double lb_0[]	= {0.15	,0.001		,0.001	,0.015		,0.000001	,0.5,	-5.0			,-5.0			,-5.0	}; // what to do about sig_psi?  Skipping that right now
	double ub_0[]	= {0.67	,2.5		,0.03	,0.04		,0.20		,1.5,	.01				,.01			,.01};
