...
*/
	...
	sig_psi = x[1];
	tau 	= x[2]; */
	double x0_0[]	= {phi,sig_psi,tau,effic,sk_wg[0],sk_wg[1],sk_wg[2],sk_wg[3]};
	double lb_0[]	= {0.15,0.05,0.001,0.1,x0_0[3]*(0.7),x0_0[4]*(0.7),x0_0[5]*(0.7),x0_0[6]*(0.7)}; // what to do about sig_psi?  Skipping that right now
	double ub_0[]	= {1.0,15.0,0.05,2.0,x0_0[3]*(1.3),x0_0[4]*(1.3),x0_0[5]*(1.3),x0_0[6]*(1.3)};
	...
	objval = bndCalMinwrap(&cal_dist,lb_1,ub_1,4,x0_1,&st,1e-7,1e-7,0.0,opt_alg);
