...
double 	phi		= 0.497773;	// : log(1/UE elasticity -1) = phi*log(theta)= log(1/.38-1)/log(5)
double 	sig_psi	= 0.006930; 	// higher reduces the switching prob
double 	tau 	= 0.031176;
double 	scale_s	= 0.049722;
double 	shape_s	= 0.089230;
double 	effic	= 1.170998;
	...
	for(l=0;l<Noccs+1;l++){
			...
			for(d=0;d<Noccs;d++){
				...
				double dtld = ss->data[ss_gld_i+l*Noccs+d]*(
								...
								- ss->data[ss_gld_i+l*Noccs+d]*dpmatch(ss->data[ss_tld_i+l*Noccs+d])*u_ret;
