...
double 	sig_psi	= .02865434;//3.671249; 	// higher reduces the switching prob
...
*/
		...
		for(l=0;l<Noccs+1;l++){
			...
			for(d=0;d<Noccs;d++){
				...
				if(ret_d->data[d]<0) //&& break_flag==1)
					gg =0;
