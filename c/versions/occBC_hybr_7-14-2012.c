...
double ** chi;
double 	tau 	= 0.009450;
double 	kappa	= 0.557;//.1306; corresponds to HM number
...
int main(int argc,char *argv[]){
	...
	*/
	...
	double chi_coef0[] ={ // these come from the solution in matlab, where weights are equal for all possible switches and w=chi
			   -0.9014,
			   -0.8336,
			   -0.5038};
