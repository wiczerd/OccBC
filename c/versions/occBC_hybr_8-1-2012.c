...
int main(int argc,char *argv[]){
	...
	*/
	...
	double lb_0[]	= {0.35	,0.001		,0.005	,0.02		,0.005		,0.35	,-2.5			,-2.5			,-2.5	}; // what to do about sig_psi?  Skipping that right now
...
int sim_moments(struct st_wr * st, gsl_vector * ss,gsl_matrix * xss){
	...
	gsl_matrix * urt_l, * urt_l_wt, * fnd_l_hist, * x_u_hist, * Zzl_hist, * s_wld,*tll_hist,*tld_hist,*fac_hist;
	if(printlev>=2){
