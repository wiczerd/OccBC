...
int printlev 	= 3;
int use_anal	= 1;
int opt_alg		= 10; // 10x => Nelder-Meade, 5x => Subplex, o.w => BOBYQA
int polish_alg	= 0;
int homosk_zeta	= 0;
int diag_zeta	= 1;
int gsl_fin_diffs=0;
...
*/
	...
	*/
	...
	//							cal_dist_df
	objval = bndCalMinwrap(&quad_solve,(lb_1.vector).data,(ub_1.vector).data,param_off ,(x0_1.vector).data,&st,1e-7,1e-7,0.0,opt_alg,polish_alg);
