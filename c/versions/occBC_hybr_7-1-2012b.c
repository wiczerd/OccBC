...
double 	kappa	= 0.25;//.1306; corresponds to HM number
double 	phi		= .45;//0.455997;	// : log(1/UE elasticity -1) = phi*log(theta)= log(1/.38-1)/log(5)
double 	fm_shr	= 0.7;	// firm's surplus share
double 	effic	= .874104;//1.162658;
...
int main(){
	...
	double chi_coef0[] = {0.02,0.015,0.00};
...
*/
	...
	*/
	...
	double ub_0[]	= {0.75	,7.5		,0.05	,0.04		,0.10		,1.5
